...
COSMOS_LOG="${COSMOS_LOG:-$PROJECT/.cache/cosmos-reason2-vllm.log}"
...
VLLM_PID=$!
COSMOS_VLLM_PID="$VLLM_PID"
export COSMOS_VLLM_PID
...
if [[ "${COSMOS_READY:-0}" != "1" ]]; then
    echo "ERROR: Cosmos did not become healthy. Check $COSMOS_LOG"
